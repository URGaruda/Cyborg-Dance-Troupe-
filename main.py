...
ruby=ia.IA(variables.dexter,20.5)
aff=Affichage(terrain)
"""l_ia=[]
for i in range(7):
    if(i%2==0):
        l_ia.append(ia.IA(variables.dexter,10.5) )
    else:
       l_ia.append( ia_tourner.Ia_Tourner(0) )
ia_carre=ia_seq.IA_Seq(variables.dexter,terrain,l_ia)
ruby.start()"""
